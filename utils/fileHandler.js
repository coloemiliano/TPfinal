...
const extensionesImagenes = ["png", "jpg", "jpeg"];

const saveFile = ({mimetype, path}, allowE, destFolder) => {
    try{
...
const imgFile = (file) => saveFile(file, extensionesImagenes,`./public/images`);
